...
extern inline void fast_memcpy(void *dst, void *src, int len);
/*
* Copies words, runs from sdram for speed. len is in words
*/
extern inline void fast_wmemcpy(void *dst, void *src, int len);

extern inline void word_8byte_copy(void *dst, void *src, int count);
extern inline void word_8byte_copy_bytereverse(short *dst, short *src, int count);

extern inline int get_stack_pointer();

extern inline void CacheControl(int mode);
extern inline void CacheClearLine(void* ptr);
extern inline void ScreenStretch(int src, int width, int height, int interp);
