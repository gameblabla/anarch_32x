...
extern void MixSamples(void *mixer, int16_t *buffer, int32_t cnt, int32_t scale);
extern void LockMixer(int16_t id);
extern void UnlockMixer(void);
